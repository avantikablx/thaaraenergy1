const MissionSection = () => {
    return (
        <section className="relative bg-black text-white min-h-[450px] sm:min-h-[540px] lg:min-h-[630px] py-14 sm:py-18 lg:py-25 overflow-hidden w-screen"
            style={{
        ...
        >
            ...
            {/* Content */}
            <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 flex flex-col gap-6 justify-center min-h-[270px] sm:min-h-[360px] lg:min-h-[450px]">
                {/* Heading */}

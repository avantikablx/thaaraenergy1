...
const Header = () => {
  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50 w-full bg-black/10 backdrop-blur-6xl">
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-24">
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="text-gray-200 hover:text-white transition-colors duration-300 p-2 rounded-lg hover:bg-black/20"
            >
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-4 pt-4 pb-6 space-y-3 bg-white/90 backdrop-blur-6xl border-t border-black/20 rounded-b-2xl">
              {navigation.map((item) => (
